---
original_url: https://docs.frappe.io/erpnext/chart-of-accounts
...
7. Change the currency if this account will be used for transactions with different currency. By default, it's the Company's currency. To know more, visit the [Multi Currency Accounting](/erpnext/multi-currency-accounting) page.
