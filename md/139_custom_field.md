---
original_url: https://docs.frappe.io/erpnext/custom-field
...
![](/files/customize-option-in-list-view.png)

1. How to create a Custom Field
---
2. Go to the Custom Field list and click on New.
3. **Document**: Select the Document in which you need to add the Custom Field.
4. **Label**: Enter what Label would you like to give to your Custom Field.
5. **Field Type**: ERPNext already has a set of Field Types defined which can be fetched from this drop-down menu. You can select the Type of your Custom Field from within this menu.
6. Update.

![](/files/new-custom-field.png)
...
![](/files/customize-erpnext-custom-field-from-customize-form.gif)
...
![](/files/custom-field-with-select-fieldtype.png)
...
![](/files/custom-field-dpends-on.png)
6. **Field Description**: You can add the description of the Field here which can be displayed below this Field.

![](/files/custom-field-description.png)
7. **Permission Level**: This will allow you to specify which roles within your organization will be able to edit this Field. You can go through [Role Based Permissions](/erpnext/role-based-permissions) for more understanding on this.
8. **In Preview**: If [Show Preview Popup](/erpnext/customize-form#13-more-properties) for the document type is checked, the Field will be included in the popup that appears on hovering over links of the document type (in list view and other link fields).
