---
original_url: https://docs.frappe.io/erpnext/customise-cash-flow-report
...
![](/files/default-cash-flow-report.png)
...
![](/files/enable-custom-cash-flow.png)
...
![](/files/new-cash-flow-mapping.png)
...
![](/files/cash-flow-mapping-for-income-tax.png)
...
![](/files/cash-flow-mapping-for-other-liabilities.png)

![](/files/cash-flow-mapping-for-receivables.png)

![](/files/cash-flow-mapping-for-payables.png)

![](/files/cash-flow-mapping-for-taxes-payables.png)

![](/files/cash-flow-mapping-inventory.png)
...
![](/files/cash-flow-mappers-standard.png)
...
![](/files/cash-flow-mapper-operating-activity.png)

Refresh the cash flow statement and view the changes.
![](/files/cash-flow-report-customized.png)
...
![](/files/cash-flow-mapping-for-property.png)

![](/files/cash-flow-mapping-for-equity.png)

![](/files/cash-flow-mapping-for-investing.png)

![](/files/cash-flow-mapping-for-financing-activities.png)

Here's what our cash flow statement now looks like:

![](/files/final-cash-flow.png)