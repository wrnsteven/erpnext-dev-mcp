---
original_url: https://docs.frappe.io/erpnext/coupon-code
...
5. Select [Pricing Rule](/erpnext/pricing-rule) having **coupon code based** flag enabled.
6. Click on Save

![](/files/coupon-code.png)
...
![](/files/coupon-code-pricing-rule.png)
